...
public class TestReader {
	...
	public static void main(String[] args) {
		...
		try {
			in = new FileReader("c:/DossierAI108/testBufferWriter.txt");
			br = new BufferedReader(in);
			String chaine2 = "";
			// me BR possède une emethode ready() qui renvoie true tant qu'il reste des él"metns à lire dans le fichier
			while(br.ready()) {
				chaine2 += br.readLine();
			}
		...
		try {
			in2 = new FileReader("c:/DossierAI108/testBufferWriter.txt");
