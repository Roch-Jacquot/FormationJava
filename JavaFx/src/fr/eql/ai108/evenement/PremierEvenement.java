...
public class PremierEvenement extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Premier evenement");
		primaryStage.show();
		
		//J'appelle la methode setOnAction sur le bouton qui provoc l'evenement
		//Premiere solution : je lui passe en argument une classe anynyme interne de EvenHandler<ActionEven>()
